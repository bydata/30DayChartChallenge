...
# Select remaining Bundesliga predictions (2023 matchday 30 starting April 28th, 2023)
...
# Naive sampling from win, draw, loss probabilities
probs <- c(0.187, 0.618, 0.195)
outcomes_home <- c("w", "l", "d")
n_samples <- 100
