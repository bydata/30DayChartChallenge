...
We choose a pretty larger font size since the plot will saved in a larger format. We also set `strip.text` to blank to remove the default facet titles in this particular plot. 

Furthermore, we define colors for the red and blue areas as well as a separate text color.
