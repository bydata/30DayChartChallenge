...
p <- df_prep %>% 
  ...
  ggrepel::geom_label_repel(
    data = . %>% filter(country %in% c("Bangladesh", "China", "Turkey",
...
animate(p_anim, res = 200, width = 6, duration = 15, fps = 16, height = 5, 
        units = "in", end_pause = 32)
anim_save(here(base_path, "19-global-change.gif"))
